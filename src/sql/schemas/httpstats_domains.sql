...
CREATE TABLE domains          ( id INT(11) NOT NULL,            name VARCHAR(255) NOT NULL,     alias_of   INT(11) NOT NULL,    uid   INT(11) NOT NULL, UNIQUE KEY `id`   (`id`),    UNIQUE KEY `name_a_u`   (`name`,  `alias_of`,   `uid`   )) ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=16;
