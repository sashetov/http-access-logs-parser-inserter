...
/* This package implements basic hash table functionality.  It is possible to search for an entry, create an entry and destroy an entry.
...
hashval_t iterative_hash (const PTR k_in /* the key */,
