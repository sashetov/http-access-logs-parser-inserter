...
CREATE TABLE pageviews_monthly (
    id              INT         NOT NULL AUTO_INCREMENT,
    date            DATETIME    NOT NULL,
    domains_id      INT         NOT NULL,
...
CREATE TABLE search_terms_monthly (
    id              INT         NOT NULL AUTO_INCREMENT,
    date            DATETIME    NOT NULL,
    domains_id      INT         NOT NULL,
    referer_id      INT         NOT NULL,
...
CREATE TABLE created_ranges_monthly (
    id              INT         NOT NULL AUTO_INCREMENT,
