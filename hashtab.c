...
static inline hashval_t htab_mod_1 (hashval_t x, hashval_t y, hashval_t inv, int shift) {
...
static PTR * find_empty_slot_for_expand (htab_t htab, hashval_t hash) {
...
PTR * htab_find_slot_with_hash (htab_t htab, const PTR element, hashval_t hash, enum insert_option insert) {
