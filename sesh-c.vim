...
badd +0 linklist.c
badd +0 linklist.h
badd +0 htlog_geoip.c
badd +0 htlog_geoip.h
badd +0 htlog_mysql.c
badd +0 htlog_mysql.h
badd +0 htlog_processing.c
badd +0 htlog_processing.h
badd +0 htlog_analyzer.cpp
args Makefile
edit Makefile
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 133 - ((71 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
133
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 302 - ((301 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
302
