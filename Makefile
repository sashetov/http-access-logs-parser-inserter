...
cloudstats: clean_local htlog_analyzer.o
	$(CC) -o cloudstats linklist.o hashtable.o ht_nodes.o htlog_processing.o htlog_geoip.o htlog_mysql.o htlog_analyzer.o $(MYSQLC_LDFLAGS) $(GEOIP_LDFLAGS)
htlog_analyzer.o:
	$(CC) -c $(CFLAGS) $(MYSQLC_CFLAGS) $(GEOIP_CFLAGS) $(DEBUG)  linklist.c hashtable.c ht_nodes.c htlog_processing.c htlog_geoip.c htlog_mysql.c htlog_analyzer.c
test_progs:
	$(MAKE) -C tests/ all
dump_cpp_vars:
	gcc -dM -E - < /dev/null
